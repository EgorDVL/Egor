...
insert into `user` values(default,'admin@gmail.com','admin' , 'EgorAdmin' , 'ZhyzhkoAdm' , 0507070342 ,1);
insert into `user` values(default,'user@gmail.com','user' , 'EgorUser' , 'ZhyzhkoUser', 0502321644,2);
...
insert into `subcategoryAccessories` values(default,'screens');
...
insert into `product` values(default,'iphone 5s', 500, 1, 1, 1, 1);
insert into `product` values(default,'l 542' , 400, 2, 2, 2, 1);
insert into `product` values(default,'iphone 5s score', 10, 3, null, 1, 2);
