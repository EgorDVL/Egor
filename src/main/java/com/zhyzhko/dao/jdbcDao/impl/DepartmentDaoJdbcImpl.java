...
import com.zhyzhko.dao.jdbcDao.DepartmentDaoJdbc;
import com.zhyzhko.dao.jdbcDao.rowmapper.impl.DepartmentRowMapper;
...
public class DepartmentDaoJdbcImpl implements DepartmentDaoJdbc {
    ...
    public boolean update(Department department) {
        return jdbcTemplate.update(UPDATE_DEPARTMENT, department.getName(), department.getId());
    }
