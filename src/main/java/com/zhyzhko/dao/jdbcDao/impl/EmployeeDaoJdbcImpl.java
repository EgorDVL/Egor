...
import com.zhyzhko.dao.jdbcDao.EmployeeDaoJdbc;
import com.zhyzhko.dao.jdbcDao.rowmapper.impl.EmployeeRowMapper;
 ...
 */
public class EmployeeDaoJdbcImpl implements EmployeeDaoJdbc {
    ...
    @Override
    public List<com.zhyzhko.models.Employee> getAllByDepartmentId(int departmentId) {
