 ...
 */
public class NurseRequestConverter implements HttpRequestConverter<Nurse> {

    private DateUtils dateUtils = new DateUtils(DateUtils.YEAR_MONTH_DAY);

    @Override
    public Nurse fromRequest(HttpServletRequest req) {
        ...
        return new Nurse(name, surname, phone, specialty, dateOfBirth, experience, photo, departmentEnum, userId);
    }
}
