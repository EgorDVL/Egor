...
<head>
    ...
    <script type="text/javascript" src="bootstrap/js/createprocedure.validator.js"></script>

    <title>Create Procedures</title>
</head>
<body>
...
<div id="search-patient-container" style="width: 650px;">
    <form class="form-horizontal" action="CreateProcedures" method="post" id="createProceduresValidator"
          id="login-form">
        <div class="control-group">
            <lable class="control-label" for="name">Procedures</lable>
            <div class="controls">
                <input placeholder="Massage" name="name" type="text" style="height: 30px;">
            </div>
        </div>
        <div class="control-group">
            <lable class="control-label" for="use">Use</lable>
            <div class="controls">
                <input placeholder="1 times a day" name="use" type="text" style="height: 30px;">
            </div>
        </div>
        <div class="control-group">
            <lable class="control-label" for="dateStart">Date start</lable>
            <div class="controls">
                <input placeholder="20-01-2017" name="dateStart" type="date" style="height: 30px;">
            </div>
        </div>
        <div class="control-group">
            <lable class="control-label" for="dateEnd">Date end</lable>
            <div class="controls">
                <input placeholder="25-01-2017" name="dateEnd" type="date" style="height: 30px;">
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="controls">
                <div id="signup-button">
                    <div>
                        <button class="btn btn-success" type="submit" style="margin-left: -76px;">Create Procedures
                        </button>
                    </div>


                    <div id="login-error-message"><span class="label label-important"
                                                        style="margin-left: -68px;">${errorMessage}</span></div>
                    <div id="login-successful-message"><span
                            class="label label-success" style="margin-left: -68px;">${successfulMessage}</span></div>
                </div>
            </div>
        </div>
    </form>
