        ...
        <c:forEach items="${createForm.showForms}" var="form" varStatus="status">
            ...
            <c:choose>
                <c:when test="${form.status eq true}">
                    ...
                    <c:choose>
                        <c:when test="${form.typeName eq 'SIMPLE_LINE'}">
                        ...
                        <c:when test="${form.typeName eq 'MULTI_LINE'}">
                            <input name="showForms[${status.index}].typeName" type="hidden"
                                   value="${form.typeName}">
                        ...
                        <c:when test="${form.typeName eq 'RADIO_BUTTON'}">
                            <input name="showForms[${status.index}].typeName" type="hidden"
                                   value="${form.typeName}">
                        ...
                        <c:when test="${form.typeName eq 'CHECK_BOX'}">
                            <input name="showForms[${status.index}].typeName" type="hidden"
                                   value="${form.typeName}">
                        ...
                        <c:when test="${form.typeName eq 'COMBO_BOX'}">
                            <input name="showForms[${status.index}].typeName" type="hidden"
                                   value="${form.typeName}">
