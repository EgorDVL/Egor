...
public class FieldServiceImpl implements FieldService {
    ...
    private static final String RADIO_BUTTON_FIELD_TYPE = "RADIO_BUTTON";
    private static final String CHECK_BOX_FIELD_TYPE = "CHECK_BOX";
    private static final String COMBO_BOX_FIELD_TYPE = "COMBO_BOX";
    ...
    private FieldDto updateFieldDto(FieldForm fieldForm, FieldDto fieldDto) {
        ...
        fieldDto.setType(typeService.createType(new TypeDto(fieldForm.getType())));
        createTypeValues(fieldForm, fieldDto);
        return fieldDto;
    }
